...
export default function MapCustomFields () {
  ...
  const processError = function processError (errors, rowIndex, customTypeKey) {
  ...
  return {
    parse: function parse (data, customType, rowIndex) {
    ...
    mapBoolean: function mapBoolean (value) {
      const result = {}
    ...
    mapMoney: function mapMoney (value) {
      const result = {}
    ...
    mapSet: function mapSet (value, elementType) {
      const result = {
        error: [],
        data: [],
      }
